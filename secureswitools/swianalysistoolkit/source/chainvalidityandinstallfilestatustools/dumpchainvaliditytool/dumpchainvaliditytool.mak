...
CPP=cl.exe
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /I "./" /I "$(EPOCROOT)epoc32\include" /I "..\..\..\..\openssllib\import\inc" /I "..\..\..\..\swisistools\source\makesis" /I "..\..\common" /I "..\common" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "GENERATE_ERRORS" /D "_UNICODE" /D "DUMPCHAINVALIDITYTOOL" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\dumpchainvaliditytool.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /GZ /c  
...
!IF EXISTS("dumpchainvaliditytool.dep")
!INCLUDE "dumpchainvaliditytool.dep"
!ELSE 
!MESSAGE Warning: cannot find "dumpchainvaliditytool.dep"
!ENDIF 
!ENDIF 
