...
%SECURITYSOURCEDIR%\installationservices\switestfw\test\autotesting\test_launcher.pl -components switools -testreleases udeb -exectimeout \ExecTimeOut.exe -resultsoutput \logs\winscw
)
