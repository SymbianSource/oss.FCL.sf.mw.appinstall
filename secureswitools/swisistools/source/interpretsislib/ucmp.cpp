...
TInt TUnicodeCompressionState::DynamicWindowOffsetIndex(TUint16 aCode)
	...
	/*
	Prefer sections that cross half-->WriteUint8L(block boundaries. These are better adapted to actual text.
...
void TUnicodeCompressionState::Panic(TPanic /*aPanic*/)
 ...
 void TUnicodeCompressor::CompressL(Serialiser& aOutput,MUnicodeSource& aInput,
 ...
 TInt TUnicodeCompressor::FlushL(Serialiser& aOutput,TInt aMaxOutputBytes,TInt& aOutputBytes)
	{
...
void TUnicodeCompressor::DoCompressL(Serialiser* aOutputStream,TUint8* aOutputPointer,MUnicodeSource* aInput,
									 TInt aMaxOutputBytes,TInt aMaxInputWords,
									 TInt* aOutputBytes,TInt* aInputWords)
	{
...
void TUnicodeCompressor::WriteSCharacter(const TAction& aAction)
 ...
 void TUnicodeExpander::ExpandL(MUnicodeSink& aOutput,Deserialiser& aInput,
 ...
 TInt TUnicodeExpander::ExpandedSizeL(Deserialiser& aInput,TInt aInputBytes)
	{
	TInt words;
	TUnicodeExpander e;
...
void TUnicodeExpander::DoExpandL(MUnicodeSink* aOutput,Deserialiser* aInputStream,const TUint8* aInputPointer,
								 TInt aMaxOutputWords,TInt aMaxInputBytes,
								 TInt* aOutputWords,TInt* aInputBytes)
	{
	iOutput = aOutput;
...
void TMemoryStreamUnicodeSink::WriteUnicodeValueL(TUint16 aValue)
	{
	iStream.write((TUint8*)&aValue,sizeof(TUint16));
	}

TUint16 TMemoryStreamUnicodeSource::ReadUnicodeValueL()
	{
	TUint16 x;
	iStream.read((TUint8*)&x,sizeof(TUint16));
	return x;
	}
