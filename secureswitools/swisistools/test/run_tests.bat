...
%SECURITYSOURCEDIR%\installationservices\switestfw\test\autotesting\test_launcher.pl -components sistools -testreleases udeb -exectimeout \ExecTimeOut.exe -resultsoutput \logs\winscw
)