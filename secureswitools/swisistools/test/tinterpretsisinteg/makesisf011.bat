...
REM testcaseF011
 ...
 call interpretsis -z .\romdrive -c \epoc32\winscw\c  -s  \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\realexe.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
:END
