...
@ECHO OFF
REM testdata_pkgversion_d003
REM CR1125 SEC-SWI-PKGVER-D003 - Installing a SIS containing a VERSION condition within compound expressions
...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/testexpressions_version2.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
