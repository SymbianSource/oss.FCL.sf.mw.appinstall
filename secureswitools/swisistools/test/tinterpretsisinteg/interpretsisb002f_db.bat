...
@ECHO OFF
REM testcaseB002f
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB002\dep6z.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep6z.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s  \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep6z.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
