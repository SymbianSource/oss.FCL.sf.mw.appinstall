...
@ECHO OFF
REM testcaseB002c
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB002\dep3z.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep3z.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s  \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep3z.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
