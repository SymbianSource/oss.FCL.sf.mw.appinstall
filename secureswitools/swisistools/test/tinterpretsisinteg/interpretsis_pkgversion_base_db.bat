...
@ECHO OFF
REM testdata_pkgversion_base
REM CR1125 SEC-SWI-PKGVER-D Base Installation for tversionpkg_app1, tversionpkg_app2, tversionpkg_app3
...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/tversionpkg_app1.sis -s /epoc32/winscw/c/tswi/tsis/data/tversionpkg_app2.sis -s /epoc32/winscw/c/tswi/tsis/data/tversionpkg_app3.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
