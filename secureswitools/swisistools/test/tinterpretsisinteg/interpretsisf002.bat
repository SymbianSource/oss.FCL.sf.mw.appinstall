...
@ECHO OFF
REM testcaseF002
call interpretsis -z .\romdrive -c .\cdrive -s  /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/eclipseromexe.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
