...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsiss005.sis -i /epoc32/winscw/c/tswi/tinterpretsisinteg/testdatas005/testinterpretsisconfigs005.ini -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
