...
@ECHO OFF
REM testcaseB003f
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB003\dep6m.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep6m.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep6m.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
