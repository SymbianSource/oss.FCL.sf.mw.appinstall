...
call interpretsis -z .\romdrive -c .\cdrive -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/indir1 -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/indir2 -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
