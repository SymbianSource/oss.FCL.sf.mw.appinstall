...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/devicelang_negativeid.sis -k 5.4  -w info -I /epoc32/winscw/c/tswi/tinterpretsisinteg/preq2525-interpretsis-19/argumentfile.ini  -l /epoc32/winscw/c/interpretsis_test_harness.txt > NUL
