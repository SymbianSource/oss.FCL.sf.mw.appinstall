...
@ECHO OFF
REM interpretsisS009
if not exist .\cdrive mkdir .\cdrive > NUL
if not exist .\romdrive mkdir .\romdrive > NUL
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsiss009.sis -i /epoc32/winscw/c/tswi/tinterpretsisinteg/testdatas009/testinterpretsisconfigs009.ini -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
