...
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam0010\interpretsism0010.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsism0010.sis > NUL
call /epoc32/winscw/c/tswi/tinterpretsisinteg/interpretsism0010_db.bat
:END