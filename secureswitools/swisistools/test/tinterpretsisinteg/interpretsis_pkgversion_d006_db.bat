...
@ECHO OFF
REM testdata_pkgversion_d006
REM CR1125 SEC-SWI-PKGVER-D006 - Installing a SIS containing an EXISTS condition with invalid data in the argument string
...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/testexpressions_version5.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
