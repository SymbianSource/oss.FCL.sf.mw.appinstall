...
@ECHO OFF
 ...
 call interpretsis -z .\romdrive -c .\cdrive -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\restore_backup_nr.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
 ...
 copy .\cdrive\sys\install\sisregistry\89334285\ \epoc32\winscw\c\sys\install\sisregistry\89334285\ /Y > NUL
copy .\romdrive\sys\install\scr\provisioned\scr.db \epoc32\winscw\c\sys\install\scr\scr.db /Y > NUL
 copy .\cdrive\sys\bin\restore_backup_nr.exe \epoc32\winscw\c\sys\bin\restore_backup_nr.exe /Y > NUL
 copy .\cdrive\sys\hash\restore_backup_nr.exe \epoc32\winscw\c\sys\hash\restore_backup_nr.exe /Y > NUL
