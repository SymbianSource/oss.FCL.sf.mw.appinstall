...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsiss006.sis -i /epoc32/winscw/c/tswi/tinterpretsisinteg/testdatas006/testinterpretsisconfigs006.ini -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
