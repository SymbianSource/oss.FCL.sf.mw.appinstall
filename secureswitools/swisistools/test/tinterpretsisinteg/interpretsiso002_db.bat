...
@ECHO OFF
REM interpretsisO002
if not exist .\cdrive mkdir .\cdrive > NUL
if not exist .\romdrive mkdir .\romdrive > NUL
call interpretsis -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/testfile1.sis -e -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
