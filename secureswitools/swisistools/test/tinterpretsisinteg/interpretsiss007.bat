...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsiss007.sis -i /epoc32/winscw/c/tswi/tinterpretsisinteg/testdatas007/testinterpretsisconfigs007.ini -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
