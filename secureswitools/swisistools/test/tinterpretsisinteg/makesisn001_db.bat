...
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdatan001\interpretsisn001.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsisn001.sis > NUL
...
call /epoc32/winscw/c/tswi/tinterpretsisinteg/interpretsisn001.bat > NUL
:END