...
call interpretsis -c .\cdrive  -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsism003.sis -t .\romdrive\system\install\ -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
