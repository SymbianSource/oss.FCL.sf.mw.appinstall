...
@ECHO OFF
REM testdata_pkgversion_d007
REM CR1125 SEC-SWI-PKGVER-D007 - Installing a SIS containing an EXISTS condition with arguments missing from the argument string
...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/testexpressions_version6.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
