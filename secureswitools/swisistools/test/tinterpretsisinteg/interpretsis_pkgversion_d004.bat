...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/testexpressions_version3.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
