...
@ECHO OFF
REM testcaseB002i
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB002\dep9z.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep9z.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s  \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep9z.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
