...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsisp001.sis -i /epoc32/winscw/c/tswi/tinterpretsisinteg/testdatap006/testinterpretsisconfigp006.ini -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
