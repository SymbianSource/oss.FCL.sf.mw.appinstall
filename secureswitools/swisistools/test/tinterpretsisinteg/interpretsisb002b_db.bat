...
@ECHO OFF
REM testcaseB002b
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB002\dep2z.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep2z.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s  \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep2z.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
