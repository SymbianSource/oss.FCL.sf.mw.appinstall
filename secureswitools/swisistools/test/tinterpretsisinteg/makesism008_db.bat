...
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam008\interpretsism008.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsism008.sis > NUL
call /epoc32/winscw/c/tswi/tinterpretsisinteg/interpretsism008_db.bat
:END