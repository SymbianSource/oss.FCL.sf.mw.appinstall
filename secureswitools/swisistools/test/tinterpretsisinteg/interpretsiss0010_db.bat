...
@ECHO OFF
REM interpretsisS0010
if not exist .\cdrive mkdir .\cdrive > NUL
if not exist .\romdrive mkdir .\romdrive > NUL
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsiss0010.sis -i /epoc32/winscw/c/tswi/tinterpretsisinteg/testdatas0010/testinterpretsisconfigs0010.ini -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
