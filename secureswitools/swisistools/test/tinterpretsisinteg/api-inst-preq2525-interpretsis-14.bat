...
@ECHO OFF
REM API-INST-preq2525-interpretsis-14
REM PREQ2525 API-INST-preq2525-interpretsis-14 - Package supports FR and EN  Language selected some negative language id 
...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/devlangsup_defaultlang.sis -k 5.4  -w info -I /epoc32/winscw/c/tswi/tinterpretsisinteg/preq2525-interpretsis-14/argumentfile.ini  -l /epoc32/winscw/c/interpretsis_test_harness.txt > NUL
