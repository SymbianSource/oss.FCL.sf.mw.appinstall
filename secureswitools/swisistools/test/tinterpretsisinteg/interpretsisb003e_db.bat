...
@ECHO OFF
REM testcaseB003e
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB003\dep5m.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep5m.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep5m.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
