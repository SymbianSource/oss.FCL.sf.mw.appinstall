...
call interpretsis -z .\romdrive -c .\cdrive -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep7m.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
