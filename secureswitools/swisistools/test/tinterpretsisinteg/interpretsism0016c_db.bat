...
call interpretsis -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsism0016_dependent.sis -t .\romdrive\system\install\ -c .\cdrive -r \epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam0016\rombld.log,\epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam0016\rombld.rofs.log -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
