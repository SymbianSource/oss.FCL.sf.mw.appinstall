...
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam004\interpretsism004.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsism004.sis > NUL

call /epoc32/winscw/c/tswi/tinterpretsisinteg/interpretsism004_db.bat
:END