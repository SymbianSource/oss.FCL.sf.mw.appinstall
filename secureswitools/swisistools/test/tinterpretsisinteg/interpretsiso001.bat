...
@ECHO OFF
REM interpretsisO001
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/testfile1.sis -e -w info -l /epoc32/winscw/c/interpretsis_test_harness.txt
