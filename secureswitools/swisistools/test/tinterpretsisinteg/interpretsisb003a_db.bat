...
@ECHO OFF
REM testcaseB003a
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB003\dep1m.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep1m.sis > NUL
call makesis \epoc32\winscw\c\tswi\tinterpretsisinteg\testdataB003\depdatm1c.pkg \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\depdatm1c.sis > NUL
...
call interpretsis -z .\romdrive -c .\cdrive -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\dep1m.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
