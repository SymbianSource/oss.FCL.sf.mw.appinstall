...
call interpretsis -s \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\interpretsism003.sis -c .\cdrive -r \epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam003\rombld.log,\epoc32\winscw\c\tswi\tinterpretsisinteg\testdatam003\rombld.rofs.log -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
