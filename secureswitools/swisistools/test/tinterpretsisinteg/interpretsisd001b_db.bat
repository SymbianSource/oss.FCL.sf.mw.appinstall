...
@ECHO OFF
REM testcaseD001b
call /epoc32/winscw/c/tswi/tinterpretsisinteg/makesisD001.bat
call interpretsis -z .\romdrive -c .\cdrive -s  \epoc32\winscw\c\tswi\tinterpretsisinteg\sisfiles\multiplelang.sis -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
