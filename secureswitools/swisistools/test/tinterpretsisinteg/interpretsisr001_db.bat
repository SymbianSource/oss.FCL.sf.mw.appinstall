...
call copy \epoc32\winscw\c\tswi\tinterpretsisinteg\data\testinterpretsisr001.txt .\cdrive\testinterpretsisr001.txt > NUL
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tinterpretsisinteg/sisfiles/interpretsisr001.sis -n 2 -w info -l /epoc32/winscw/c/interpretsis_test_harness_db.txt
