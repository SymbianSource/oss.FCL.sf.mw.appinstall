...
call interpretsis -z .\romdrive -c .\cdrive  -s /epoc32/winscw/c/tswi/tsis/data/devlangsup_defaultlang.sis -w info -I /epoc32/winscw/c/tswi/tinterpretsisinteg/preq2525-interpretsis-04/argumentfile.ini  -l /epoc32/winscw/c/interpretsis_test_harness_db.txt > NUL
