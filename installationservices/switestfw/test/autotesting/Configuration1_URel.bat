...
call %SECURITYSOURCEDIR%\installationservices\switestfw\test\autotesting\installSwiCertStore.bat tcertstore\data\swicertstore.dat
call %SECURITYSOURCEDIR%\installationservices\switestfw\test\autotesting\setupSwiPolicy swipolicy.ini
