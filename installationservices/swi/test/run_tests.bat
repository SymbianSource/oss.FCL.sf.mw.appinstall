...
%SECURITYSOURCEDIR%\installationservices\switestfw\test\autotesting\test_launcher.pl -components swi -testreleases udeb -exectimeout \ExecTimeOut.exe -resultsoutput \logs\winscw
)
