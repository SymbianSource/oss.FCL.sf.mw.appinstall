...
class CAddEntryStep : public CSisRegistryWritableSessionStep 
	{
public:
	CAddEntryStep();
	virtual TVerdict doTestStepL();
...
class CUpdateEntryStep : public CSisRegistryWritableSessionStep 
	{
public:
	CUpdateEntryStep();
	virtual TVerdict doTestStepL();
...
class CSingleEntryDeleteStep : public CSisRegistryWritableSessionStep 
	{
public:
	CSingleEntryDeleteStep();
	virtual TVerdict doTestStepL();
	};

class CPackageExistsInRomStep : public CSisRegistryWritableSessionStep 
	{
public:
	CPackageExistsInRomStep();
	virtual TVerdict doTestStepL();
	};
