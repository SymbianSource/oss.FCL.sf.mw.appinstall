...
namespace Test
 {
    _LIT(KIntegrityServicesServerName, "!tintegrityservicesserver");
    _LIT(KIntegrityServicesServerImage, "tintegrityservicesserver"); 
...
private:
	...
	CDummyIntegrityServices* iIntegrityServices;
	};
 } // namespace Test
} // namespace Swi
