...
*/
SQLITE_EXPORT int sqlite3_load_extension(
...
*/
SQLITE_EXPORT int sqlite3_enable_load_extension(sqlite3 *db, int onoff){
  if( onoff ){
...
*/
SQLITE_EXPORT int sqlite3_auto_extension(void *xInit){
  int i;
  int rc = SQLITE_OK;
  sqlite3OsEnterMutex();
...
*/
SQLITE_EXPORT void sqlite3_reset_auto_extension(void){
  sqlite3OsEnterMutex();
