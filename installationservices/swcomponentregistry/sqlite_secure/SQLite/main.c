...
SQLITE_EXPORT void *sqlite3_malloc(int nByte){ return nByte>0 ? sqlite3OsMalloc(nByte) : 0; }
SQLITE_EXPORT void *sqlite3_realloc(void *pOld, int nByte){ 
  if( pOld ){
    if( nByte>0 ){
...
*/
SQLITE_EXPORT int sqlite3_global_recover(){
  return SQLITE_OK;
}
#endif
...
*/
SQLITE_EXPORT int sqlite3_enable_shared_cache(int enable){
...
SQLITE_EXPORT int sqlite3_table_column_metadata(
