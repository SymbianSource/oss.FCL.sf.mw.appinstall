...
static int pager_playback_one_page(Pager *pPager, OsFile *jfd, int useCksum){
  ...
  ** page in the pager cache (the only exception to this rule is if the
  ** pager is currently being shut down and the hash-table has
  ** already been discarded). In this case just update the pager cache,
