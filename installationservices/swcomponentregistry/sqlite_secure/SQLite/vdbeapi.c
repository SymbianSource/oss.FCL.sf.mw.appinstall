...
*/
SQLITE_EXPORT const char *sqlite3_column_database_name(sqlite3_stmt *pStmt, int N){
  return columnName(
      pStmt, N, (const void*(*)(Mem*))sqlite3_value_text, COLNAME_DATABASE);
}
#ifndef SQLITE_OMIT_UTF16
SQLITE_EXPORT const void *sqlite3_column_database_name16(sqlite3_stmt *pStmt, int N){
  return columnName(
...
** anything else which is not an unabiguous reference to a database column.
*/
SQLITE_EXPORT const char *sqlite3_column_table_name(sqlite3_stmt *pStmt, int N){
  return columnName(
      pStmt, N, (const void*(*)(Mem*))sqlite3_value_text, COLNAME_TABLE);
}
#ifndef SQLITE_OMIT_UTF16
SQLITE_EXPORT const void *sqlite3_column_table_name16(sqlite3_stmt *pStmt, int N){
  return columnName(
...
** anything else which is not an unabiguous reference to a database column.
*/
SQLITE_EXPORT const char *sqlite3_column_origin_name(sqlite3_stmt *pStmt, int N){
  return columnName(
      pStmt, N, (const void*(*)(Mem*))sqlite3_value_text, COLNAME_COLUMN);
}
#ifndef SQLITE_OMIT_UTF16
SQLITE_EXPORT const void *sqlite3_column_origin_name16(sqlite3_stmt *pStmt, int N){
  return columnName(
...
SQLITE_EXPORT int sqlite3_bind_null(sqlite3_stmt* p, int i){
