...
# Make sure tclsqlite3secure was compiled correctly.  Abort now with an
...
proc abandon_testing {} {
  finish_test
  puts "*** WARNING: Skipping the rest of this file due to errors ***"

  catch {unread_lock_db}
  catch {db close}
  catch {db2 close}
  catch {db3 close}
...
proc copy_file {from to} {
  if {$::tcl_platform(platform)=="unix" && ![string equal $::tcl_platform(osSystemName) "Symbian"]} {
