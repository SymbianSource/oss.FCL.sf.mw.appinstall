...
static RTest TheTest(_L("tsqlitesecure_perf test"));
_LIT(KTestDir, "c:\\test\\");
_LIT(KTestDbName,   "c:\\test\\tsqlitesecure_perf.db");
_LIT8(KTestDbName8, "c:\\test\\tsqlitesecure_perf.db\x0");
...
/**
@SYMTestCaseID			PDS-SQLITE3SEC-UT-4035
...
static void SqlServerMultiUpdateTest(const char aUpdateSql[], TInt aUpdateRecIds[], TInt aUpdateRecCnt)
	{
    TheTest.Next( _L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4035"));
	(void)KillProcess(KSqlSrvName);
...
/**
@SYMTestCaseID			PDS-SQLITE3SEC-UT-4037
...
static void SqlServerMultiSelectTest(const char aSelectSql[], TInt aSelectRecIds[], TInt aSelectRecCnt)
	{
	TheTest.Next( _L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4037"));
	(void)KillProcess(KSqlSrvName);
...
/**
@SYMTestCaseID			PDS-SQLITE3SEC-UT-4039
...
static void SqlServerSingleUpdateTest(const char aSingleUpdateSql[], TInt aUpdateRecId)
	{
	TheTest.Next( _L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4039"));
	(void)KillProcess(KSqlSrvName);
...
static void DoSqliteLibraryTests(TPerfTestMode aPerfTestMode)
	...
	TheTest.Next( _L("SQLite: library version"));
	const char* verstr = SqliteVersion();
	TBuf<32> ver;
	ver.Copy(TPtrC8((const TUint8*)verstr));
	TheTest.Printf(_L("%S\r\n"), &ver);
	...
	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4026: SQLite, configuration: %S: insert %d records in a single transaction"),
	...
	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4027: SQLite, configuration: %S: update %d records in a single transaction"),
	...
	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4028: SQLite, configuration: %S: delete %d records in a single transaction"),
	...
	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4029: SQLite, configuration: %S: select %d records"),
	...
	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4030: SQLite, configuration: %S: insert a single record"),
	...
	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4031: SQLite, configuration: %S: update a single record"),
							aPerfTestMode == EPerfTestSqliteSqlMode ? &KSqliteConfigSql : &KSqliteConfigDefault);
	TheTest.Next(msgbuf);
	SqliteSingleUpdateTest(aPerfTestMode, KSingleUpdateSql, TheUpdateRecId);

	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4032: SQLite, configuration: %S: delete a single record"),
							aPerfTestMode == EPerfTestSqliteSqlMode ? &KSqliteConfigSql : &KSqliteConfigDefault);
	TheTest.Next(msgbuf);
	SqliteSingleDeleteTest(aPerfTestMode, KSingleDeleteSql, TheDeleteRecId);

	msgbuf.Format(_L("@SYMTestCaseID:PDS-SQLITE3SEC-UT-4033: SQLite, configuration: %S: select a single record"),
							aPerfTestMode == EPerfTestSqliteSqlMode ? &KSqliteConfigSql : &KSqliteConfigDefault);
	TheTest.Next(msgbuf);
