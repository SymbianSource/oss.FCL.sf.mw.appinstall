...
proc tcltest::DefineConstraintInitializers {} {
    ...
    ConstraintInitializer winOnly \
	    {string equal $::tcl_platform(platform) windows}
    ConstraintInitializer symbianOnly \
	    {string equal $::tcl_platform(osSystemName) Symbian}
    ...
    ConstraintInitializer symbian {testConstraint symbianOnly}
    ...
    ConstraintInitializer tempNotSymbian {expr {![testConstraint symbian]}}
    ...
    ConstraintInitializer symbianCrash {expr {![testConstraint symbian]}}
