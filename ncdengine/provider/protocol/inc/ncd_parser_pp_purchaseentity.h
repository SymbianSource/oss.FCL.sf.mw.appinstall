...
#ifndef NCD_PREMINET_PROTOCOL_PURCHASEENTITY_PARSER_H
#define NCD_PREMINET_PROTOCOL_PURCHASEENTITY_PARSER_H
 ...
 */
class CNcdPreminetProtocolPurchaseEntityParser : public CNcdSubParser
    {
public:
    static CNcdPreminetProtocolPurchaseEntityParser* NewL( 
    ...
    virtual ~CNcdPreminetProtocolPurchaseEntityParser();
...
protected:
     ...
     */
    CNcdPreminetProtocolPurchaseEntityImpl* iEntity;
    
    };

#endif //NCD_PREMINET_PROTOCOL_PURCHASEENTITY_PARSER_H
